...
namespace Piwik\Plugins\UserFlow\Reports;
 ...
 */
class GetUserFlowTree extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('UserFlow_UserFlowTree');
        $this->dimension     = null;
        ...
        $this->subcategoryId = 'UserFlow_UserFlowTree';
    }
...
//        $view -> data = \Piwik\API\Request::processRequest('UserFlow.getUserFlowTree');
//        return $view -> render();
//    }
