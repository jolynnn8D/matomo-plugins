...
namespace Piwik\Plugins\ReactFormAnalytics\Reports;
 ...
 */
class GetForms extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('ReactFormAnalytics_Forms');
        $this->dimension     = null;
...
//         $this->actionToLoadSubTables = $this->action;
        ...
        // If a subcategory is specified, the report will be displayed in the menu under this menu item
         $this->subcategoryId = 'ReactFormAnalytics_Forms';
    }
    ...
    public function configureView(ViewDataTable $view)
    {
        ...
        $view->config->columns_to_display = array_merge(array('label', 'users', 'average_time', 'average_clicks'));
    }
    ...
    {
        $view = new View('@ReactFormAnalytics/getForms');
        $view->myData = array();
